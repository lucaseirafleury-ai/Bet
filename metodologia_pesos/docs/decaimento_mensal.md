...
| 2026-09-08 | Cartões+Árbitro (Série B, stake reduzido) — **pós-correção do carregador de médias de árbitro** (`previsao_dia.py`/`checar_decaimento.py` liam o JSONL bruto direto, `d.get("yellowcards_home") or 0`, sem passar pelo sentinela — a MÉDIA DO ÁRBITRO (não só a resolução da aposta) vinha inflada/rebaixada por jogos com cartões ausentes contados como 0; unificado numa única função `cartoes_arbitro.carregar_referees_cartoes`, ver `docs/retrospectiva_conferencia_geral_2026-09-08.md`) | n=206 ROI=+17.1% z=+2.74 acerto=64% | n=52 ROI=+22.5% z=+1.87 acerto=67% |
| 2026-09-08 | BTTS — **auditoria de fechamento**, dado real atualizado (11 jogos novos/liga, incremental corrigido — item 59) | n=189 ROI=+21.6% z=+3.02 acerto=61% (idêntico ao já documentado — zero exposição aos bugs de hoje) | n=13 ROI=+19.2% z=+0.70 acerto=62% |
| 2026-09-08 | Over 2.5 — auditoria de fechamento, dado real atualizado | n=71 ROI=+29.7% z=+2.42 acerto=62% (idêntico ao já documentado) | n=7 ROI=-45.1% z=-1.27 acerto=29% |
| 2026-09-08 | Cartões+Árbitro (Série B, stake reduzido) — auditoria de fechamento, dado real atualizado | n=208 ROI=+16.0% z=+2.56 acerto=63% (n subiu de 206→208 — 2 jogos novos reais entraram na amostra, decaimento normal, não bug) | n=54 ROI=+17.9% z=+1.49 acerto=65% |
| 2026-09-16 | Cartões+Árbitro (Série B, stake reduzido) — **pós-correção do bug "sem sugestão nova desde 02/09"** (`retrospectiva.prever_jogo` exigia `real` não-nulo até pra mercados não obrigatórios; jogo futuro de cartões nunca tem `real` ainda — critério ficou 19 dias sem gerar sugestão ao vivo; backtest nunca foi afetado, só o caminho ao vivo; ver `docs/retrospectiva_cartoes_sem_sugestao_2026-09-16.md`) | n=218 ROI=+15.1% z=+2.47 acerto=62% (crescimento orgânico de n=208→218, mesma lógica de backtest) | n=60 ROI=+12.8% z=+1.10 acerto=62% |
| 2026-09-16 | BTTS — reexecução pós-fix (não afetada, só confirma) | n=192 ROI=+22.5% z=+3.18 acerto=61% | n=16 ROI=+30.1% z=+1.32 acerto=69% |
| 2026-09-16 | Over 2.5 — reexecução pós-fix (não afetada, só confirma) | n=72 ROI=+30.6% z=+2.52 acerto=63% | n=8 ROI=-28.1% z=-0.80 acerto=38% |
